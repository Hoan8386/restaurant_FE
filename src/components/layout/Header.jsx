...
const Navbar = () => {
  ...
  return (
    <>
          ...
          <div className="row g-3 px-md-0 align-items-center">
            ...
            <div className="col-md text-center fz-14">
              <div className="d-flex justify-content-center align-items-center gap-2">
                <MailOutlined />
                <span style={{ color: "#A0A09F" }}>hoan33356@gmail.com</span>
              </div>
            </div>
      ...
      {/* Navbar */}
      <nav
        className=" nav border-bottom border-white border-opacity-25 py-2"
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-2">
              <Link
                to="/"
                className="nav__brand text-white fw-bold fs-5 text-decoration-none"
              >
                Feliciano
              </Link>
            </div>
              ...
              <div className="d-none d-md-block">
                <ul className="d-flex mb-0 gap-3">
                  <li className=" px-2 flex items-center justify-center">
                    <NavLink
                      className=" nav_link text-white text-decoration-none px-2 "
                      to="/"
                    >
                      Home
                    </NavLink>
                  ...
                  {user.id ? (
                    <li className="position-relative">
                      <div
                        className="dropdown"
                        ref={(ref) => (window.userDropdownRef = ref)}
                      >
                        <button
          ...
          {listItemCart.map((item) => (
            <div className="cart_item" key={item.id}>
              ...
              >
                ...
                <div
                  className="shopping__item__content"
                  style={{ width: "250px", padding: "0 12px" }}
                >
                  <span
                    className="shopping__item__name"
                    style={{ display: "block" }}
                  >
                  ...
                  >
                    ...
                    />
                    <span
                      className="shopping__item__price"
                      style={{ color: "#fff" }}
                    >
